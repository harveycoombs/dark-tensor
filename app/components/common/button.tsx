...
export default function Button({ children, classes, url, transparent, ...rest }: Properties) {
    let appearance = transparent ? "bg-transparent text-slate-600 font-semibold hover:bg-slate-100 hover:text-slate-500 active:bg-slate-200/75 active:text-slate-600/75" : "bg-blue-600 text-white hover:bg-blue-700 active:bg-blue-800";
