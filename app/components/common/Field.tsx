...
export default function Field({ type, classes, error, warning, ...rest }: Properties) {
    ...
    const classList = `px-4 py-3 box-border rounded-full text-sm border ${borderColor} bg-gradient-to-br ${baseColor} leading-none duration-300 select-none focus:outline-none ${focusBorderColor} ${focusShadow} hover:shadow-[inset_0_2px_4px_rgba(255,255,255,0.9),inset_0_-2px_4px_rgba(0,0,0,0.05),0_4px_8px_rgba(0,0,0,0.08)] focus:shadow-[inset_0_2px_4px_rgba(255,255,255,0.9),inset_0_-2px_4px_rgba(0,0,0,0.05),0_8px_16px_rgba(0,0,0,0.12)] backdrop-blur-sm backdrop-saturate-150 transition-all ease-out ${classes?.length ? " " + classes : ""}`;
