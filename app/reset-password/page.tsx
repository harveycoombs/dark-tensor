    ...
    return (
        <main className="min-h-[calc(100vh-55px)] grid place-items-center">
            <section className="text-center">
                ...
                <strong className="block text-sm font-medium select-none text-gray-400/60">Reset Password</strong>
                <PasswordResetForm />
                <div className="text-[0.825rem] font-medium text-gray-400 mt-3 text-center select-none">
                    <Link href="mailto:issues@darktensor.harveycoombs.com" className="hover:underline">Report An Issue</Link>
                </div>
            </section>
        </main>
    );
